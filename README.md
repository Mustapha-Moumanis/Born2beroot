...
TCP (Transmission Control Protocol)
     ...
     != “UDP (User Datagram Protocol) that have multiple(one sender and multiple receivers)/podcast(one sender and all receivers) connection. “
...
User log :
true cmd : 	who | cut -d " " -f 1 | sort -u | wc -l
